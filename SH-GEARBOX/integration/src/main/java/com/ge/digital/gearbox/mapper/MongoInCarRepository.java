...
//    List<Users> findByUsername(String name1);  
	...
	@Query(value = "{" +
            ...
            "    line:{$regex:?3}\n" +
            "}")
	List<InCar> findInCarByEquipIdAndTimeRange(String equipId, Date start, Date end, String lineNum);
	List<InCar>  findByEquipIdAndTimestampBetweenAndLine(String equipId,  Date start, Date end, String lineNum);
