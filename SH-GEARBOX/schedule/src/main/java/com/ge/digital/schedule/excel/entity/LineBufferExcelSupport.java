...
@Entity
public class LineBufferExcelSupport extends LineBuffer implements ExcelUploadSupport {
	...
	@ExcelSign(title = "bufferID", checkNull = true)
	Integer bufferID;
	@ExcelSign(title = "capacity", checkNull = true)
	Integer capacity;
